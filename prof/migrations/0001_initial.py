# Generated by Django 2.2.12 on 2020-04-11 07:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prof.Speciality')),
        ...
        migrations.AddField(
            model_name='trainer',
            name='specialities',
            field=models.ManyToManyField(through='prof.Trainer_speciality', to='prof.Speciality'),
        ),
        migrations.CreateModel(
            name='Degree',
            fields=[
