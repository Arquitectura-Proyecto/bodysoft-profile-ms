...
router.register(r'specialities', Speciality_ViewSet.SpecialityViewSet)
router.register(r'trainerSpecialities', Trainer_speciality_ViewSet.TrainerSpecialityViewSet)
